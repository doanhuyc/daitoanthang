<?php
	...
	if($s_all)            $counter        .=  '<li class="dangonl"> '. $all.': <strong>'.($all_visitors+10000).'</strong></li>';
    if($s_today)        $counter        .= '<li class="dangonl"> '.$today.' : <strong>'.($today_visitors+10).'</strong></li>';
    if($s_yesterday)    $counter        .= '<li class="dangonl"> '.$yesterday.' : <strong>'.$yesterday_visitors.'</strong></li>';
   
    if($s_week)            $counter        .= '<li class="dangonl"> '.$x_week.' : <strong>'.$week_visitors.'</strong></li>';
    if($s_month)        $counter        .=  '<li class="dangonl"> '. $x_month.' : <strong>'.$month_visitors.'</strong></li>';
