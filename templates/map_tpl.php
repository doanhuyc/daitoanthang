                ...
                <div class="tcat">Bản Đồ Công Ty</div>
                <div class="content">
                <div>	
  ...
  <script type="text/javascript">
		   ...
		   var infowindow_array= new Array();function initialize(){
			   ...
			   infoWindowArray[7895] = '<div class="map_description"><div class="map_title"><?=$map['ten']?></div><div>Email : <?=$map['mota']?> </br> Điện thoại: <?=$map['dienthoai']?> </div></div>';
