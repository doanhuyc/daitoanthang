	...
	<div class="content">
    	...
    	<?
			if(is_array($_SESSION['cart'])){
            	echo '<tr bgcolor="#075992" style="font-weight:bold;color:#FFF"><td align="center">STT</td><td>Tên</td><td align="center">Giá</td><td align="center">Số lượng</td><td align="center">Tổng giá</td></tr>';
