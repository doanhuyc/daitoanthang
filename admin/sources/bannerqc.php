...
function save_banner(){
	...
	if($id){ // cap nhat
		if($photo = upload_image("file_vi", 'swf|png|jpg|JPG|PNG|jpeg|JPEG', _upload_hinhanh,$file_name)){
			$data['photo_vi'] = $photo;
			$d->setTable('photo');
			$d->setWhere('id', $id);
			$d->select();
		...
		if($photo1 = upload_image("file_en", 'swf|png|jpg|JPG|PNG|jpeg|JPEG', _upload_hinhanh,$file_name1)){
		...
		$data['photo_vi'] = upload_image("file_vi", 'swf|png|jpg|JPG|PNG|jpeg|JPEG', _upload_hinhanh,$file_name1);
		if(!$data['photo_vi']) $data['photo_vi']="";
		$data['photo_en'] = upload_image("file_en", 'swf|png|jpg|JPG|PNG|jpeg|JPEG', _upload_hinhanh,$file_name2);
...
function save_banner_giua(){
	...
	if($id){ // cap nhat
		if($photo = upload_image("file", 'swf|png', _upload_hinhanh,$file_name)){
			$data['photo'] = $photo;
			$d->setTable('photo');
			$d->setWhere('id', $id);
			$d->select();
		...
		$data['photo'] = upload_image("file", 'swf|png', _upload_hinhanh,$file_name);
