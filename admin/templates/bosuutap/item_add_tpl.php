...
function get_main_item()
	{
		$sql_huyen="select * from table_bosuutap_item order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=bosuutap&act=save" enctype="multipart/form-data" class="nhaplieu">
<!--   <b>Danh mục:</b><?=get_main_item();?><br /><br />-->
   <?php if (@$_REQUEST['act']=='edit')
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=bosuutap&act=man'" class="btn" />
</form>