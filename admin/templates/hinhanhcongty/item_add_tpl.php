...
<h3>Thêm hình ảnh công ty</h3>
<?php
function get_main_item()
	{
		$sql_huyen="select * from table_hinhanhcongty_item order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=hinhanhcongty&act=save" enctype="multipart/form-data" class="nhaplieu"> 
   ...
   <?php if (@$_REQUEST['act']=='edit')
	...
	<b>Link</b> <div> <input type="text" name="mota_vi" value="<?=@$item['mota_vi']?>" class="input" /></div><br />
   <!-- <b>Mô tả EN</b> <div> <textarea name="mota_en" cols="50" rows="5" id="mota_en"><?=@$item['mota_en']?></textarea> </div>
     ...
     <b>Nội dung EN</b><br/><div> <textarea name="noidung_en" id="noidung_en"><?=$item['noidunen']?></textarea></div>
	-->
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=hinhanhcongty&act=man'" class="btn" />
</form>