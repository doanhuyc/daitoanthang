...
<h3>Dịch vụ</h3>
<form name="frm" method="post" action="index.php?com=dv_text&act=save" enctype="multipart/form-data" class="nhaplieu">
  <!--<?php if (@$_REQUEST['act']=='capnhat')
    ...
    <b>Nội dung EN</b><br/><div><textarea name="noidung_en" id="noidung_en"><?=$item['noidung_en']?></textarea></div>
	<input type="hidden" name="id" id="id" value="<?=@$item['id']?>" />
	<input type="submit" value="Lưu" class="btn" />
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=dv_text&act=capnhat'" class="btn" />
</form>