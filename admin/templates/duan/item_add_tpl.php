...
function get_main_item()
	{
		$sql_huyen="select * from table_duan_item order by stt,id desc ";
...
?>
<form name="frm" method="post" action="index.php?com=duan&act=save" enctype="multipart/form-data" class="nhaplieu"> 
