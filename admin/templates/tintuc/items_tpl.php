...
<h3><a href="index.php?com=news&act=add">Thêm sự kiện</a></h3>
...
<table class="blue_table">
	...
	<tr>
       ...
       <td style="width:30%;" align="center">
		...
		<td style="width:40%;" align="center"><a href="index.php?com=news&act=edit&id_item=<?=$items[$i]['id_item']?>&id=<?=$items[$i]['id']?>" style="text-decoration:none;"><?=$items[$i]['ten_vi']?></a></td>
		<td style="width:6%;">
