...
<form name="frm" method="post" action="index.php?com=lienhe&act=save" enctype="multipart/form-data" class="nhaplieu">
    ...
    <b>Email</b> <input type="text" name="mota" value="<?=$item['mota']?>" class="input" /><br />   <br /> 
    ...
    <b>Thông tin liên hệ Vi</b><br/><div><textarea name="noidung_vi" id="noidung_vi"><?=$item['noidung_vi']?></textarea></div>
    <b>Thông tin liên hệ En</b><br/><div><textarea name="noidung_en" id="noidung_en"><?=$item['noidung_en']?></textarea></div>
