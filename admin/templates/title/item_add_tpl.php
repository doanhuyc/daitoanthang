...
<form name="frm" method="post" action="index.php?com=title&act=save" enctype="multipart/form-data" class="nhaplieu">
	...
	<b>Title VN:</b> <input type="text" name="ten_vi" value="<?=@$item['ten_vi']?>" class="input" /><br /><br>
    <b>Title EN:</b> <input type="text" name="ten_en" value="<?=@$item['ten_en']?>" class="input" /><br /><br>
